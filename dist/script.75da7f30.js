...
Promise.all([faceapi.nets.tinyFaceDetector.loadFromUri('/models'), faceapi.nets.faceLandmark68Net.loadFromUri('/models')]).then(startVideo);
function startVideo() {
  return _startVideo.apply(this, arguments);
} // Function to get webcam access
function _startVideo() {
  _startVideo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var existingVideo;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // Check for an existing video element (in case of pause/resume)
          existingVideo = videoContainer.querySelector('video');
          if (!existingVideo) {
            _context.next = 4;
            break;
          }
...
function getWebcam() {
  return _getWebcam.apply(this, arguments);
} // Function to detect faces
function _getWebcam() {
  _getWebcam = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var video;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 22:
          ...
          console.error('Error accessing webcam:', _context2.t0);
          if (_context2.t0.name === 'NotAllowedError' || _context2.t0.name === 'PermissionDeniedError') {
            alert('Please allow camera access to use FocusMirror.');
          } else if (_context2.t0.name === "NotFoundError" || _context2.t0.name === "DevicesNotFoundError") {
...
function _detectFaces() {
  _detectFaces = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var videoEl, options;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          videoEl = document.querySelector("#video-container video"); // options for face detection
          options = new faceapi.TinyFaceDetectorOptions(); // main loop
        case 2:
          if (!isCameraOn) {
            _context3.next = 11;
            break;
          ...
          _context3.next = 5;
          return faceapi.detectAllFaces(videoEl, options).withFaceLandmarks();
        case 5:
          faceDetections = _context3.sent;
...
function updateTimerDisplay() {
  ...
  var secs = seconds % 60;
  timerElement.textContent = "".concat(pad(hours), ":").concat(pad(minutes), ":").concat(pad(secs));
}
function pad(num) {
  return (num < 10 ? "0" : "") + num;
}
