...
function _getWebcam() {
  _getWebcam = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var video;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 21:
          ...
          if (_context.t0.name === 'NotAllowedError' || _context.t0.name === 'PermissionDeniedError') {
            alert('Please allow camera access to use FocusMirror.');
          } else if (_context.t0.name === "NotFoundError" || _context.t0.name === "DevicesNotFoundError") {
